        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                Digital Product Design | UI/UX Designer
              </motion.h2>
            </div>
            ...
            >
             With 2+ years of experience in digital design and visual communication, I specialize in creating clean, user-friendly UX/UI designs for web and mobile products. Skilled in wireframing, prototyping, design systems, and visual branding, with the ability to turn business goals and user needs into clear, consistent, and usable interface design
            </motion.p>
            ...
            >
              ...
              >
                ...
                <a href="/SOKLENG_PHEN_UXUI.pdf" download>
                  View CV
                </a>
              </motion.button>
            </motion.div>
